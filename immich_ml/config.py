...
class ProviderProfiles(BaseModel):
    ...
    clip: str | None = None
    clip_textual: str | None = None
    clip_visual: str | None = None
    facial_recognition: str | None = None
    facial_recognition_detection: str | None = None
    facial_recognition_recognition: str | None = None
    ocr: str | None = "CPUExecutionProvider"
    ocr_detection: str | None = None
...
class Settings(BaseSettings):
    ...
    coreml_retry_cpu_on_failure: bool = True
